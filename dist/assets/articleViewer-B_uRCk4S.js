import{m as l}from"./index-Bjkd7MJK.js";function c({title:o,content:i,images:a=[]}){const r=document.createElement("div");r.className="h-full flex flex-col article-viewer";let e=(Array.isArray(i)?i.join(`
